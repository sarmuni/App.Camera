...
namespace APP.Capture.Infrastructure
{
	...
	{
		private DAL DALInfo;
		private string ApplicationName = "Capture";
		...
		private string APPConnectionDev
		{
			...
			{
				string returnValue = "";
				returnValue = "Data Source=IDSRGVPDBS01;Initial Catalog=ACL;Persist Security Info=True;User ID=appadmin;Password=appadmin2018;" + SQLProfilerInfo;
				return returnValue;
			}
		}
